# Версия 0.2.0
# программа дя скачивания видео с Ютуба в обычном качестве и в лучшем качестве
# Скачивает 1 видео или 1 аудио
...
tk.Radiobutton(root, text="Аудио (MP3) Только Аудио", variable=mode, value="audio").pack(anchor="w")
